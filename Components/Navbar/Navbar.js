                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
                        <div>
                            <div className="hidden lg:block cursor-pointer" role="img" aria-label="luxe. Logo.">
                                <svg className="fill-stroke " width={55} height={25} viewBox="0 0 55 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div className="hidden md:block">
                            <ul className="flex items-center space-x-6">
                                ...
                                <li>
                                    <a href="javascript:void(0)" className="text-lg font-semibold">
                                        {" "}
                                        About{" "}
                                    </a>
                                </li>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <a aria-label="my account" href="javascript:void(0)" className="">
