                    ...
                    <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
                        ...
                        <div className="hidden md:block">
                            <ul className="flex items-center space-x-6">
                                <li>
                                    <a href="javascript:void(0)" className="dark:text-white dark:hover:text-gray-300 text-lg text-right text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        {" "}
                                        Home{" "}
                                    </a>
                                </li>
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <a aria-label="my account" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800  p-0.5 rounded">
                            ...
                            <a aria-label="Favourites" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800  p-0.5 rounded">
                            ...
                            <a aria-label="Bag" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800  p-0.5 rounded">
